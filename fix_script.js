const fs = require('fs');
let lines = fs.readFileSync('src/app/login/page.tsx', 'utf8').split(/\r?\n/);
lines[86] = `    if (isSignup) { router.push('/onboarding'); } else { router.push('/home'); }`;
lines[87] = `    return (
...
fs.writeFileSync('src/app/login/page.tsx', lines.join('\n'));
console.log("Successfully replaced lines 87 and 88!");
